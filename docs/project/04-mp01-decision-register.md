...
**Sonuç: conditional pass for decision-backed slices.** `DEC-MP01-001`–`009` ve `012`, 27 Ağustos 2026 ürün kararıyla geliştirme için onaylandı. Cari hesap, dönem, para, posting ve yetki dilimleri gerçek politika davranışıyla ilerleyebilir. `DEC-MP01-010` banka/reconciliation, isimli uzman kabulü ve resmi/production kararları kendi kapsamlarını ve MP-03 çıkış kapısını bloklamaya devam eder.

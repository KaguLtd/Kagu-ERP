...
| MP-02 | Repository ve geliştirme platformu | in-progress | Çalışan iskelet, CI, local Compose, auth ve DB | Temiz kurulum ve restore smoke |
...
Durum kanıtı (19 Ağustos 2026): bağımsız repository, .NET solution, strict web workspace, Android scaffold ve yerel CI sözleşmesi oluşturuldu. Android build JDK/SDK; local Compose Docker yokluğu nedeniyle açık kapıdır. Ayrıntı ve komut kanıtı [MP-02 yaşayan görev planındadır](docs/project/plans/2026-08-19-repository-bootstrap.md).
